...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PD1     ------> UART4_TX
    */
    GPIO_InitStruct.Pin = Rx_485_1_Pin|Tx_485_1_Pin;
  ...
  */
    ...
    PC11     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = Tx_485_3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART3;
    HAL_GPIO_Init(Tx_485_3_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = Rx_485_3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART3;
    HAL_GPIO_Init(Rx_485_3_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PD1     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOD, Rx_485_1_Pin|Tx_485_1_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, Tx_485_2_Pin|Rx_485_2_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, Tx_Debug_Pin|Rx_Debug_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PC11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOC, Tx_485_3_Pin|Rx_485_3_Pin);
...
void USART_UART_Init(uint8_t port, PortConfig_rs485_t* config)
{
